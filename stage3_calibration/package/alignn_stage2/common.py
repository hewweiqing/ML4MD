...
SEEDS = tuple(range(5))
STAGE3_VERSION = 1
CONDITIONS = ("A_Control_raw", "B_Control_temperature_scaled",
    "C_Random2_Descriptor_raw", "D_Random2_Descriptor_temperature_scaled",
    "E_Random2_Coordinate_raw", "F_Random2_Coordinate_temperature_scaled",
    "G_Random2_Full_raw", "H_Random2_Full_temperature_scaled")
